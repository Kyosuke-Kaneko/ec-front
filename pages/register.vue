              ...
              <form @submit.prevent="login" class="inner-elements">
                  <validation-provider v-slot="{ errors }" rules="required|email">
                    ...
                    <div class="element">
                      ...
                      <input type="email" v-model="Lemail" placeholder="email" id="email">
                    </div>
                  </validation-provider>
                    ...
                    <div class="element">
                      ...
                      <input type="password" v-model="Lpassword" placeholder="password" id="password">
                    </div>
                  </validation-provider>
